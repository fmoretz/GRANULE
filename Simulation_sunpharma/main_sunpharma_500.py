...
for index in range(0, len(day_sim)):
	...
	E_final_500 = _E[-1]
	M_final_500 = _M[-1]
	M_vol_final_500 = _M_vol[-1]

	S_ss_final_500 = S_ss[-1]
	X_ss_final_500 = X_ss[-1]
	E_ss_final_500 = E_ss[-1]
	M_ss_final_500 = M_ss[-1]
	M_vol_ss_final_500 = M_vol_ss[-1]

	M_cumulative_final_500 = M_cumulative[-1]
