...
from sunpharma_1000 import S_final_1000 as So, X_final_1000 as X0, E_final_1000 as Eo, M_final_1000 as Mo
...
for index in range(0, len(day_sim)):
	...
	# ∞∞ VISZ ∞∞
	t = np.linspace(1000, day, len(_S))
	t_ss = np.linspace(1000, day, len(M_ss))
