...
from sunpharma_1500 import S_final_1500 as So, X_final_1500 as X0, E_final_1500 as Eo, M_final_1500 as Mo
...
for index in range(0, len(day_sim)):
	...
	# ∞∞ VISZ ∞∞
	t = np.linspace(1500, day, len(_S))
	t_ss = np.linspace(1500, day, len(M_ss))
