...
for index in range(0, len(day_sim)):
	...
	for k in range(1, N+1):
		...
		[So, Xo, Eo, To, Mo],
		t,
		args=(Q, Vef/N, So, Xo, Eo, _R, Y, Kd, eta, U, A_lateral, rho_biomass, cp, m, To, Tw, Na, w1),
		atol=1e-7,  
		rtol=1e-9,
		mxstep=100000
		)
	...
	fig8, axs8 = plt.subplots(1, 1, figsize=(8, 8))
	plt.subplots_adjust(
		left   = 0.125,
		bottom = 0.071,
		right  = 0.9,
	...
	axs8.plot(np.linspace(0, N, N), _omega, 'k', linewidth=2, marker='.', markersize=10, linestyle='solid')
	axs8.set_xlabel('N° CSTR')
	axs8.set_ylabel('Omega [m$^3$/h]')
	axs8.set_xlim([0,N])
	axs8.set_title('Washout flow [m$^3$/h]', fontsize=16)
	axs8.grid(color='k', alpha=0.5, linestyle='dashed', linewidth=0.8)

	fig_pathway = '../output'
	fig8.savefig('biomass_washout.svg')	
	...
	axs3[0,0].plot(np.linspace(0, N, N), _wOLR, 'k', linewidth=2, marker='.', markersize=10, linestyle='solid')
	axs3[0,0].set_xlabel('N° CSTR')
	axs3[0,0].set_ylabel('w$_{OLR}$ - [-]')
	axs3[0,0].set_xlim([0,N])
	axs3[0,0].set_title('OLR washout function', fontsize=16)
	axs3[0,0].grid(color='k', alpha=0.5, linestyle='dashed', linewidth=0.8)

	axs3[0,1].plot(np.linspace(0, N, N), _wbed, 'k', linewidth=2, marker='.', markersize=10, linestyle='solid')
	axs3[0,1].set_xlabel('N° CSTR')
	axs3[0,1].set_ylabel('w$_{bed}$ - [-]')
	axs3[0,1].set_xlim([0,N])
	axs3[0,1].set_title('Bed washout function', fontsize=16)
	axs3[0,1].grid(color='k', alpha=0.5, linestyle='dashed', linewidth=0.8)

	axs3[1,0].plot(np.linspace(0, N, N), _wup, 'k', linewidth=2, marker='.', markersize=10, linestyle='solid')
	axs3[1,0].set_xlabel('N° CSTR')
	axs3[1,0].set_ylabel('w$_{up}$ - [-]')
	axs3[1,0].set_xlim([0,N])
	axs3[1,0].set_title('Upflow velocity washout', fontsize=16)
	axs3[1,0].grid(color='k', alpha=0.5, linestyle='dashed', linewidth=0.8)
 
	axs3[1,1].plot(np.linspace(0, N, N), _wM, 'k', linewidth=2, marker='.', markersize=10, linestyle='solid')
	axs3[1,1].set_xlabel('N° CSTR')
	axs3[1,1].set_ylabel('w$_M$ - [-]')
	axs3[1,1].set_xlim([0,N])
	axs3[1,1].set_title('Methane washout', fontsize=16)
	axs3[1,1].grid(color='k', alpha=0.5, linestyle='dashed', linewidth=0.8)

	fig_pathway = '../output'
	fig3.savefig('washout contributions.svg')	


	#axs3[2,0].plot(np.linspace(0, N, N), _w, 'k-o', linewidth=1, label='Washout')
	...
	axs5.plot(np.linspace(0, N, N), _omega, 'k', linewidth=2, marker='.', markersize=10, linestyle='solid')
	axs5.set_xlabel('N° CSTR')
	axs5.set_ylabel('Omega [m$^3$/h]')
	axs5.set_xlim([0,N])
	axs5.set_title('Washout flow [m$^3$/h]', fontsize=16)
	axs5.grid(color='k', alpha=0.5, linestyle='dashed', linewidth=0.8)

	fig_pathway = '../output'
	fig5.savefig('omega.svg')	
