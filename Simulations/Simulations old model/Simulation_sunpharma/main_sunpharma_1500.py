...
from main_sunpharma_1000 import S_final_1000 as So, X_final_1000 as Xo, M_final_1000 as Mo 
from main_sunpharma_1000 import S_ss_final_1000, X_ss_final_1000, M_ss_final_1000
from main_sunpharma_1000 import M_cumulative_final_1000, M_vol_final_1000, M_vol_ss_final_1000
...
for index in range(0, len(day_sim)):
	...
	S_ss[0] = S_ss_final_1000; X_ss[0] = X_ss_final_1000; E_ss[0] = Eo; M_ss[0] = M_ss_final_1000

	M_cumulative[0] = M_cumulative_final_1000 
	M_vol_ss[0] = M_vol_ss_final_1000
	...
	S_final_1500 = _S_graph[-1]
	X_final_1500 = _X_graph[-1]
	E_final_1500 = _E_graph[-1]
	M_final_1500 = _M_graph[-1]
	M_vol_final_1500 = _M_vol[-1]

	S_ss_final_1500 = S_ss[-1]
	X_ss_final_1500 = X_ss[-1]
	E_ss_final_1500 = E_ss[-1]
	M_ss_final_1500 = M_ss[-1]
	M_vol_ss_final_1500 = M_vol_ss[-1]

	M_cumulative_final_1500 = M_cumulative[-1]
