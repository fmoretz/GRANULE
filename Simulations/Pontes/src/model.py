...
def model():
	...
	t_exp = [0, 0.25/24, 0.5/24, 0.8/24, 1/24, 1.4/24, 2.0/24, 2.7/24, 3.6/24, 5/24, 6/24, 20/24]
	S_bolle = [3.0, 2.5, 2.0, 1.3, 0.95, 0.4,0.17, 0.07, 0.04, 0.025, 0, 0]
	...
	figure.savefig(fig_pathway + 'Substrate.svg')	
